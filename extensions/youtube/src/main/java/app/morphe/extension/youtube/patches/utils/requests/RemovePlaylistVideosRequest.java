 ...
 * <p>
 * {@link EditPlaylistRequest} removes a single video and caches the result per video id, which
 * suits the queue manager. This is the bulk path: it sends one edit request per chunk of
